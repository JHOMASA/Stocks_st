...
# Other functions (analyze_news_sentiment, calculate_risk_metrics, etc.) remain unchanged...

# Chat Interface HTML and CSS
def chat_interface(choice):
    ...
    <script>
        function sendMessage(event, choice) {{
            ...
            // Simulate bot response based on choice
            let botResponse = '';
            if (choice === 'Stock Analysis') {{
                botResponse = `Fetching stock data for ${{message}}...`;
            }} else if (choice === 'Monte Carlo Simulation') {{
                botResponse = `Running Monte Carlo simulation for ${{message}}...`;
            }} else if (choice === 'Financial Ratios') {{
                botResponse = `Calculating financial ratios for ${{message}}...`;
            }} else if (choice === 'News Sentiment') {{
                botResponse = `Analyzing news sentiment for ${{message}}...`;
            }} else if (choice === 'Latest News') {{
                botResponse = `Fetching latest news for ${{message}}...`;
            }} else if (choice === 'Recommendations') {{
                botResponse = `Generating recommendations for ${{message}}...`;
            }} else if (choice === 'Predictions') {{
                botResponse = `Predicting stock prices for ${{message}}...`;
            }} else {{
                botResponse = `I'm here to help! What would you like to do?`;
            }}
